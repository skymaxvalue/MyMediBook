...
import { selectOrganizationList, selectOrganizationState } from 'src/app/Store/Organization/organization.selectors';
...
export class SelectHospitalComponent implements OnInit {
  ...
  continueToDashboard(): void {
    ...
    localStorage.setItem(
      'selectedHospital',
      JSON.stringify(this.selectedHospital)
    );
